...
<div class="col-md-12 py-5">
    <div class="white_shd full margin_bottom_30">
        ...
        <form action="{{ route('admin.paket.edit') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body" style="padding: 28px;">
                <div class="row">
                    <div class="col-6 mb-3">
                        ...
                        <input type="text" name="nama" class="form-control" value="{{ $paket->nama_paket }}" id="nama_paket">
                    </div>
                    <div class="col-6 mb-3">
                        <label for="harga_paket" class="form-label">Harga Paket</label>
                        <input type="number" name="harga" class="form-control" value="{{ $paket->harga }}" id="harga_paket">
                    </div>
                </div>
                <div class="mb-3">
                    <label for="deskripsi" class="form-label">Deskripsi Paket</label>
                    <textarea name="deskripsi" id="deskripsi" class="form-control">{!! $paket->nama_paket !!}</textarea>
                </div>
                <div class="mb-3">
